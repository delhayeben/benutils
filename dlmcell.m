...
%DLMCELL Cell array to text file.
%Writes a cell array of strings or numerics to text file.
%
% Syntax: dlmcell(file,cell_arr,delim,perm,endline)
%
% Inputs:
%   file          output filename [string]
%   cell_arr      cell array to be written [cell]
%   delim         [optional] defines the delimiter symbol (default is a tab: '\t')
%   permission    [optional] defines the permission: 'w' for write (default); 'a' for append
%   endline       [optional] define a string to append at the end of each line
%
% Outputs:
%   (none)
